...
public:
    ...
    void drawDefiningPolygon(const std::vector<QPointF> &controlPoints, const QString &name = "", const QColor &color = QColor(0, 0, 0), const Qt::PenStyle &penStyle = Qt::SolidLine, double width = 1) const noexcept;
